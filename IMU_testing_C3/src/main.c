...
void read_data (void)
{
    ...
    // printf("IS THERE NEW DATA: ");
    // bool new_data = l3gd20h_new_data (sensor);
    // printf("%s \n", new_data ? "true" : "false");
    // printf("\n WHAT IS THE DATA: ");
...
void user_init(void)
{
    ...
    if (sensor)
    {
        ...
        #else // INT_USED
        printf("inside period sesnor readinggggggggg \n");

        // create a user task that fetches data from sensor periodically
        xTaskCreate(user_task_periodic, "user_task_periodic", TASK_STACK_DEPTH, NULL, 2, NULL);
        printf("doneeeeeeeeeeeeeeeee period sesnor readinggggggggg \n");
